...
class Perspective : CanvasWatchFaceService() {

    override fun onCreateEngine(): Engine {
        return Engine()
    }

    private class EngineHandler(reference: Perspective.Engine) : Handler() {
        private val mWeakReference: WeakReference<Perspective.Engine> = WeakReference(reference)
    ...
    inner class Engine : CanvasWatchFaceService.Engine() {
        ...
        override fun onCreate(holder: SurfaceHolder) {
            ...
            setWatchFaceStyle(
                WatchFaceStyle.Builder(this@Perspective)
        ...
        private fun registerReceiver() {
            ...
            this@Perspective.registerReceiver(mTimeZoneReceiver, filter)
        }
        ...
        private fun unregisterReceiver() {
            ...
            this@Perspective.unregisterReceiver(mTimeZoneReceiver)
        }
