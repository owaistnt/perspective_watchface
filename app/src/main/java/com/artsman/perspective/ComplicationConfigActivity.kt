...
class ComplicationConfigActivity : Activity(), View.OnClickListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mLeftComplicationId=Perspective.Companion.getComplicationId()
        mWatchFaceComponentName = ComponentName(applicationContext, Perspective::class.java)
    ...
    override fun onClick(v: View?) {
        val supportedTypes= Perspective.getComplicationSupportedType()
